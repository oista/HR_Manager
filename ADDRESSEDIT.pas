...
begin
 case CommandType of
  ...
  inherited;
  xcitezenid:= StrToInt(PKDBTable1.Fields.ParentKey.FieldVal);
end;
...
procedure TADDRESS.RunCommand;
begin   //  архивация всех старых адрксов при вводе нового
  inherited;
  if CommandType=tcInsert then
   begin
    INSERT_ADRESS.Params[0].Value := xcitezenid;
    INSERT_ADRESS.ExecProc;
   end;
end;
