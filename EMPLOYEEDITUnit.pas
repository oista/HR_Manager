...
begin
  case CommandType of
    ...
    tcUpdate:
      Begin
        ...
        ADQuery1.Open;
        if (ADQuery1WORKCONTRACTID.AsString<>'') then
  ...
  if ( CommandType=tcInsert ) and (PKDBTable1.Fields.ParentKey.FieldVal<>'')  then
    begin
...
begin
  ...
  PKDBDictEdit3.DictionaryValue := PKDBBLabelCombobox5.selectid;
