inherited HOLIDAYEDIT: THOLIDAYEDIT
  ...
  inherited PageControl1: TPageControl
    ...
    inherited TabSheet1: TTabSheet
      ...
      object PKDBLabelEdit3: TPKDBLabelEdit
        ...
        Height = 21
        TabOrder = 3
        Text = #1044#1072#1090#1072' '#1085#1072#1095#1072#1083#1072' '#1086#1090#1087#1091#1089#1082#1072
        EditKind = ekDateEdit
        Table = PKDBTable1
        TableField = 'INDATE'
        EditLabel.Width = 109
        EditLabel.Height = 13
        EditLabel.Caption = #1044#1072#1090#1072' '#1085#1072#1095#1072#1083#1072' '#1086#1090#1087#1091#1089#1082#1072
      end
      ...
      object LE_1: TPKDBLabelEdit
        Left = 17
        Top = 204
        Width = 153
        Height = 21
        TabOrder = 6
        Text = #1050#1072#1083#1083#1077#1085#1076#1072#1088#1085#1099#1077' '#1076#1085#1080
        Table = PKDBTable1
        TableField = 'CALDAYS'
        EditLabel.Width = 98
        EditLabel.Height = 13
        EditLabel.Caption = #1050#1072#1083#1083#1077#1085#1076#1072#1088#1085#1099#1077' '#1076#1085#1080
      end
      object LE_2: TPKDBLabelEdit
        Left = 208
        Top = 204
        Width = 145
        Height = 21
  ...
  inherited PKDBTable1: TPKDBTable
    Fields = <
      ...
      item
        FieldName = 'INDATE'
        FieldLabel = #1044#1072#1090#1072' '#1085#1072#1095#1072#1083#1072' '#1086#1090#1087#1091#1089#1082#1072
        Nullable = True
        FieldType = ftsDate
        DisplayName = 'INDATE'
      end
      ...
      item
        FieldName = 'CALDAYS'
        FieldLabel = #1050#1072#1083#1083#1077#1085#1076#1072#1088#1085#1099#1077' '#1076#1085#1080
        Nullable = True
        FieldType = ftsString
        DisplayName = 'CALDAYS'
      end>
